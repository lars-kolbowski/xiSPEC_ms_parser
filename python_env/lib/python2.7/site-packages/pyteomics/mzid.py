...
class MzIdentML(xml.IndexedXML):
    ...
    _indexed_tags = {
        ...
        'SpectrumIdentificationProtocol', 'DataCollection',             # LK edit
        # 'AnalysisSoftwareList', 'Provider', 'AuditCollection', 'AnalysisCollection',    #CC edit
        # 'AnalysisProtocolCollection', 'BibliographicReference'          # CC edit
    }
